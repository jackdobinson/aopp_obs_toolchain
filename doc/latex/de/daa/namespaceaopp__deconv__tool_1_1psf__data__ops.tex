...
\item 
np.\+ndarray \mbox{\hyperlink{namespaceaopp__deconv__tool_1_1psf__data__ops_a9119c91cdd8de15604d05bf8944cd8ba}{get\+\_\+centre\+\_\+of\+\_\+mass\+\_\+offsets}} (np.\+ndarray data, tuple\mbox{[}int,...\mbox{]} axes, np.\+ndarray$\vert$None roi\+\_\+mask=None)
\item 
...
\item 
np.\+ndarray \mbox{\hyperlink{namespaceaopp__deconv__tool_1_1psf__data__ops_a77e0b620abe6cdf4232184c7b8552bec}{normalise}} (np.\+ndarray data, tuple\mbox{[}int,...\mbox{]}$\vert$None axes=None, tuple\mbox{[}int,...\mbox{]}$\vert$None cutout\+\_\+shape=None, recentre\+\_\+around\+\_\+centre\+\_\+of\+\_\+mass=False, remove\+\_\+background=True)
\item 
...
\item 
np.\+ndarray \mbox{\hyperlink{namespaceaopp__deconv__tool_1_1psf__data__ops_a1341f48440c941ca947dfc28a66dece2}{trim\+\_\+around\+\_\+centre}} (np.\+ndarray data, tuple\mbox{[}int,...\mbox{]} axes, tuple\mbox{[}int,...\mbox{]} output\+\_\+shape)
\end{DoxyCompactItemize}
...
\index{aopp\_deconv\_tool.psf\_data\_ops@{aopp\_deconv\_tool.psf\_data\_ops}!get\_centre\_of\_mass\_offsets@{get\_centre\_of\_mass\_offsets}}
\index{get\_centre\_of\_mass\_offsets@{get\_centre\_of\_mass\_offsets}!aopp\_deconv\_tool.psf\_data\_ops@{aopp\_deconv\_tool.psf\_data\_ops}}
\doxysubsubsection{\texorpdfstring{get\_centre\_of\_mass\_offsets()}{get\_centre\_of\_mass\_offsets()}}
{\footnotesize\ttfamily  np.\+ndarray aopp\+\_\+deconv\+\_\+tool.\+psf\+\_\+data\+\_\+ops.\+get\+\_\+centre\+\_\+of\+\_\+mass\+\_\+offsets (\begin{DoxyParamCaption}\item[{np.\+ndarray}]{data,  }\item[{tuple\mbox{[}int,...\mbox{]}}]{axes,  }\item[{np.\+ndarray $\vert$ None }]{roi\+\_\+mask = {\ttfamily None} }\end{DoxyParamCaption})}
...
\begin{DoxyVerb}    Ensure an array of data fufils the following conditions:
    ...
    * cut out a region around the centre to remove unneeded data.\end{DoxyVerb}
 Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{centre}
\leavevmode
...
\index{aopp\_deconv\_tool.psf\_data\_ops@{aopp\_deconv\_tool.psf\_data\_ops}!trim\_around\_centre@{trim\_around\_centre}}
\index{trim\_around\_centre@{trim\_around\_centre}!aopp\_deconv\_tool.psf\_data\_ops@{aopp\_deconv\_tool.psf\_data\_ops}}
\doxysubsubsection{\texorpdfstring{trim\_around\_centre()}{trim\_around\_centre()}}
{\footnotesize\ttfamily  np.\+ndarray aopp\+\_\+deconv\+\_\+tool.\+psf\+\_\+data\+\_\+ops.\+trim\+\_\+around\+\_\+centre (\begin{DoxyParamCaption}\item[{np.\+ndarray}]{data,  }\item[{tuple\mbox{[}int,...\mbox{]}}]{axes,  }\item[{tuple\mbox{[}int,...\mbox{]}  }]{output\+\_\+shape }\end{DoxyParamCaption})}

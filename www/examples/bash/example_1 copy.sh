...
#:HIDE
sleep 5; screenshot_process ./figures/sci-file.png

QFitsView ${STD_FILE}[PRIMARY] &
#:HIDE
sleep 5; screenshot_process ./figures/std-file.png
...
#:begin{CELL}
ds9 ./example_data/ifu_observation_datasets/single_wavelength_example_std.fits -scale log -crosshair 200 200 physical &

#:HIDE
sleep 5; screenshot_process ./figures/std-file-pixel.png

#:HIDE
kill $!; ds9 -fits ./example_data/ifu_observation_datasets/single_wavelength_example_std.fits -header save ./figures/std-file-header.txt -exit
